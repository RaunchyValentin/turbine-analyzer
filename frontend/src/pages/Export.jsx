      ...
      <section style={SECTION}>
        ...
        <div style={FIELD}>
          ...
          {keyTypes.length === 0 && !loadingTypes && turbineId && (
            <div style={{ fontSize: '0.8rem', color: '#7a9a7a' }}>No keyed parameters found — all params will be exported</div>
          )}
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
            {keyTypes.map(({ prefix, count }) => (
              <label key={prefix} style={{
                ...
                <span style={{ fontSize: '0.7rem', color: selected.has(prefix) ? '#4a6a4a' : '#7a9a7a' }}>{count.toLocaleString()}</span>
              </label>
            ))}
          </div>
        </div>
      ...
      <section style={SECTION}>
        ...
        <div style={FIELD}>
          ...
          {allTurbines.length === 0
            ? <div style={{ color: '#7a9a7a', fontSize: '0.85rem' }}>No turbines yet</div>
            : (
        ...
        <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <button
            ...
            style={{ ...BTN, background: restoring ? '#eef3ee' : '#fff', borderColor: '#7aaa7a', opacity: snapTurbineId ? 1 : 0.4 }}
        ...
        <div style={{ fontSize: '0.72rem', color: '#7a9a7a', marginTop: 4 }}>
